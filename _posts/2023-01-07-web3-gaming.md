...
image: 
  path: /assets/images/web3gaming_header.jpg
layout: post
---
...
<!--![Fortnite Game Store]({{ "/assets/images/ingame_items_fornite.png" | relative_url }}){:style="display:block; margin-left:auto; margin-right:auto"}{: width="380"}-->

{% include image.html
            img="/assets/images/ingame_items_fornite.png"
            title="title for image"
            caption="Fornite in-game items" %}
...
{% include image.html
            img="/assets/images/open_marketplace.png"
            title="title for image"
            caption="Open Marketplace to trade NFTs" %}
...
- [What is Web3 Gaming?](#what-is-web3-gaming)
- [Main features of Web3 Gaming](#main-features-of-web3-gaming)
- [Some Web3 games!](#some-web3-games)
...
{% include image.html
            img="/assets/images/web3gamingsection.jpg"
            title="title for image"
            caption="Gaming on Blockchain" %}
...
{% include image.html
            img="/assets/images/winwin.jpg"
            caption="Web3 Gaming is a win for both gamers and the Gaming Studios!!" %}
...
{% include image.html
            img="/assets/images/dalle_rareingameitem.png"
            caption="A scarce to find asset! (AUTO)" %}
...
{% include image.html
            img="/assets/images/dalle_aguywithjoy.png"
            caption="A gamer having the fun! (AUTO)" %}
